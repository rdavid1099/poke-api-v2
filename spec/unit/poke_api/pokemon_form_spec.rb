RSpec.describe PokeApi::PokemonForm, :vcr do
  describe '#initialize' do
    it 'creates a PokemonForm object from raw json data' do
      ...
      expect(pokemon_form.order).to eq(548)
      expect(pokemon_form.form_order).to eq(1)
      ...
      expect(pokemon_form.form_name).to eq("plant")
      ...
      expect(pokemon_form.version_group.class).to eq(PokeApi::VersionGroup)
