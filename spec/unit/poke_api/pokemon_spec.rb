RSpec.describe PokeApi::Pokemon, :vcr do
  describe '#initialize' do
    it 'creates a Pokemon object from raw json data' do
      ...
      expect(pokemon.held_items.first.class).to eq(PokeApi::Pokemon::PokemonHeldItem)
      expect(pokemon.location_area_encounters.first.class).to eq(PokeApi::Pokemon::LocationAreaEncounter)
